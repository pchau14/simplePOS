...
import {getInfo, setBillAddress} from "../actions/order";
...
const BillingModal = () => {
    ...
    useEffect(() => {
        if (!err) {
            dispatch(setBillAddress(localStorage.getItem('customer_token'), localStorage.getItem('cart_id'), data)).then(() => {
        ...
        <>
            {infos.cart ? (
                <>
                    ...
                    <Modal title="New Billing Address" open={isModalOpen} onOk={form.submit} onCancel={handleCancel}>
                        <Form onFinish={handleSubmit} form={form}>
                            ...
                            <Form.Item label='Country'>
                                <Input className='shippingInput' value='VN' placeholder='VN' disabled/>
                            </Form.Item>
